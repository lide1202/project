...
public abstract class BaseDao<T, ID> extends AbstractBaseDao implements
	...
	public T selectById(ID id) {
		logger.debug("开始调用{}的findById方法,传入的参数是{}。", new Object[] {
		...
		logger.debug("结束执行{}的selectById方,执行的结果是{}。", new Object[] {
	...
	public T selectById(String properties, String values) {
		return findOneByStatementPostfix(".selectById",
				new String[] { properties }, new String[] { values }, null,
				null);
	}

	public T selectById(String[] properties, Object... values) {
		logger.debug("开始调用{}的selectById()方法。", this.getClass().getName());
	...
	public List<T> queryByPage(String[] properties, Object[] propertyValues,
		...
		List<T> list = null;
		if (rowBounds == null) {
			list = getSqlSession().selectList(clazzName + POSTFIX_QUERYBYPAGE,
					map);
		} else {
			list = getSqlSession().selectList(clazzName + POSTFIX_QUERYBYPAGE,
					map, rowBounds);
	...
	public List<T> selectByIds(List<ID> ids) {
		logger.debug("开始调用{}的findByIds方法,传入的参数是{}。", new Object[] {
		...
		logger.debug("结束执行{}的findByIds方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public List<T> selectByMap(String[] properties, Object[] propertyValues,
		...
		logger.debug(
				...
				"开始调用{}的findByMap方法,传入的参数是properties={},propertyValues={},orderBy={},order={}。",
		...
		logger.debug("结束执行{}的findByMap方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public List<T> pageLikeByMap(String[] properties, Object[] propertyValues,
		...
		logger.debug(
				...
				"开始调用{}的pageLikeByMap方法,传入的参数是properties={},propertyValues={},orderBy={},order={},pageSize={},pageNo={}。",
				new Object[] { this.getClass().getName(), properties,
		...
		logger.debug("结束执行{}的pageLikeByMap方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public T insert(T entity) throws PersistenceException {
		logger.debug("开始调用{}的insert方法,传入的参数是entity={}。", new Object[] {
		...
		try {
			...
			logger.debug("执行{}的insert方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行数据插入出错。", ex);
		}
		logger.debug("结束执行{}的insert方法,结果是{}。", new Object[] {
				this.getClass().getName(), entity });
		return entity;
	}
	...
	public T update(T entity) throws PersistenceException {
		logger.debug("开始调用{}的update方法,传入的参数是entity={}。", new Object[] {
				this.getClass().getName(), entity });
		if (entity == null)
		...
		try {
			...
			logger.debug("执行{}的update方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行数据更新出错。", ex);
		}
		logger.debug("结束执行{}的update方法,结果是{}。", new Object[] {
				this.getClass().getName(), entity });
		return entity;
	}
	...
	public void deleteById(ID id) throws PersistenceException {
		logger.debug("开始调用{}的deleteById方法,传递的参数是id={}。", new Object[] {
				this.getClass().getName(), id });
		if (id == null)
		...
		try {
			...
			logger.debug("执行{}的deleteById方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行删除出错。", ex);
		}
		logger.debug("结束执行{}的deleteById方法。", this.getClass().getName());
	}
	...
	public void deleteByIds(List<ID> ids) throws PersistenceException {
		logger.debug("开始调用{}的deleteByIds方法,传递的参数是ids={}。", new Object[] {
				this.getClass().getName(), ids });
		if (CollectionUtils.isEmpty(ids))
			throw new PersistenceException("主键为空！");
		try {
			...
			"执行{}的deleteByIds方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行批量删除出错。", ex);
		}
		logger.debug("结束执行{}的deleteByIds方法。", this.getClass().getName());
	}

	/*
	 * public Integer count(String propertyName, Object propertyValue) { return
	 * count(new String[] { propertyName }, new Object[] { propertyValue }); }
	 */
	...
	public Integer count(String[] propertyNames, Object... propertyValues)
		...
		"开始调用{}的count方法,传入的参数propertyNames={},propertyValues={}", new Object[] {
				this.getClass().getName(), propertyNames, propertyValues });
		Map<String, Object> map = buildMap(propertyNames, propertyValues);
		int cout = getSqlSession().selectOne(clazzName + POSTFIX_COUNT, map);
		logger.debug("结束执行{}的count方法,执行的结果是{}。", new Object[] {
	...
	public Integer count(Map<String, Object> map) {
		...
		"开始调用{}的count方法,传入的参数是：{}", map.toString());
		int cout = getSqlSession().selectOne(clazzName + POSTFIX_COUNT, map);
		logger.debug("结束执行{}的count方法,执行的结果是{}。", new Object[] {
				this.getClass().getName(), cout });
	...
	public Integer countLikeByMap(String[] propertyNames,
		...
		"开始调用{}的countLikeByMap方法,传入的参数propertyNames={},propertyValues={}",
		...
		logger.debug("结束执行{}的countLikeByMap方法,执行的结果是{}。", new Object[] {
				this.getClass().getName(), cout });
		return cout;
	}
	...
	public Integer countByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的countByStatementPostfix方法,传入的参数statementPostfix={},propertyNames={},propertyValues={}",
		...
		logger.debug("结束执行{}的countByStatementPostfix方法，执行的结果是{}。",
	...
	public Integer countByStatementPostfix(String statementPostfix,
		...
		"开始调用{}的countByStatementPostfix方法,传入的参数map={},", new Object[] {
				this.getClass().getName(), statementPostfix, map.toString() });
		if (StringUtils.isEmpty(statementPostfix))
			return 0;
		Integer cout = (Integer) getSqlSession().selectOne(
				clazzName + statementPostfix, map);
	...
	public List<ID> findIdsByMap(String[] properties, Object[] propertyValues,
		...
		logger.debug(
				...
				"开始调用{}的findIdsByMap方法,传入的参数是properties={},propertyValues={},orderBy={},order={}。",
				new Object[] { this.getClass().getName(), properties,
						propertyValues, orderBy, order });
		Map<String, Object> map = buildMapWithOrder(properties, propertyValues,
				orderBy, order);
		...
		logger.debug("结束执行{}的findIdsByMap方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public List<T> pageQueryByMap(String[] properties, Object[] propertyValues,
		...
		logger.debug(
				...
				"开始调用{}的pageQueryByMap方法,传入的参数是properties={},propertyValues={},orderBy={},order={},pageSize={},pageNo={}。",
				new Object[] { this.getClass().getName(), properties,
						propertyValues, orderBy, order, pageSize, pageNo });
		Map<String, Object> map = buildMapWithOrderAndPagination(properties,
				propertyValues, orderBy, order, pageSize, pageNo);
		...
		logger.debug("结束执行{}的pageQueryByMap方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public List<ID> pageQueryIdsByMap(String[] properties,
		...
		logger.debug(
				...
				"开始调用{}的pageQueryIdsByMap方法,传入的参数是properties={},propertyValues={},orderBy={},order={},pageSize={},pageNo={}。",
				new Object[] { this.getClass().getName(), properties,
						propertyValues, orderBy, order, pageSize, pageNo });
		Map<String, Object> map = buildMapWithOrderAndPagination(properties,
				propertyValues, orderBy, order, pageSize, pageNo);
		...
		logger.debug("结束执行{}的pageQueryIdsByMap方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public int update(ID id, String[] properties, Object[] propertyValues)
		...
		"开始调用{}的update方法,传入的参数是id={},properties={},propertyValues={}。",
	...
	public int updateByIdsMap(List<ID> ids, String[] properties,
		...
		logger.debug(
				...
				"开始调用{}的updateByIdsMap方法,传入的参数是ids={},properties={},propertyValues={}。",
		...
		try {
			...
			"执行{}的updateByIdsMap方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行批量数据更新出错。", ex);
		}
		logger.debug("结束执行{}的updateByIdsMap方法,结果是{}。", new Object[] {
				this.getClass().getName(), count });
		return count;
	}
	...
	public void deleteByIdsMap(List<ID> ids, String[] properties,
		...
		logger.debug(
				...
				"开始调用{}的deleteByIdsMap方法,传递的参数是ids={},properties={},propertyValues={}。",
				new Object[] { this.getClass().getName(), ids, properties,
						propertyValues });
		if (CollectionUtils.isEmpty(ids))
			throw new PersistenceException("主键为空！");
		...
		try {
			...
			"执行{}的deleteByIdsMap方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行批量删除出错。", ex);
		}
		logger.debug("结束执行{}的deleteByIdsMap方法。", this.getClass().getName());
	}
	...
	public int deleteByMap(String[] properties, Object[] propertyValues)
		...
		"开始调用{}的deleteByMap方法,传递的参数是properties={},propertyValues={}。",
				new Object[] { this.getClass().getName(), properties,
						propertyValues });
		Map<String, Object> map = buildMap(properties, propertyValues);
		int count = 0;
		try {
			...
			"执行{}的deleteByMap方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行批量删除出错。", ex);
		}
		logger.debug("结束执行{}的deleteByMap方法,执行的结果是{}。", new Object[] {
				this.getClass().getName(), count });
		return count;
	}
	...
	public List<T> findByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的findByStatementPostfix方法,传递的参数是statementPostfix={},properties={},propertyValues={},orderBy={},order={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
		...
		List<T> list = getSqlSession().selectList(clazzName + statementPostfix,
				map);
		logger.debug("结束执行{}的findByStatementPostfix方法,结果是{}，size={}。",
	 ...
	 */
	public List<T> findByStatementPostfix(String statementPostfix,
			Map<String, Object> map, String orderBy, String order)
			throws PersistenceException {
		logger.debug(

				"开始调用{}的findByStatementPostfix方法,传递的参数是statementPostfix={},map,orderBy={},order={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
						map.toString(), orderBy, order });
		if (StringUtils.isEmpty(statementPostfix))
			return null;
		List<T> list = getSqlSession().selectList(clazzName + statementPostfix,
				map);
	...
	public T findOneByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的findOneByStatementPostfix方法,传递的参数是statementPostfix={},properties={},propertyValues={},orderBy={},order={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
						properties, propertyValues, orderBy, order });
		if (StringUtils.isEmpty(statementPostfix))
			return null;
		...
		logger.debug("结束执行{}的findOneByStatementPostfix方法,结果是{}。", new Object[] {
				this.getClass().getName(), t });
		return t;
	}
	...
	public List<T> pageQueryByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的findByStatementPostfix方法,传递的参数是statementPostfix={},properties={},propertyValues={},orderBy={},order={},pageSize={},pageNo={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
		...
		"结束执行{}的pageQueryByStatementPostfix方法,结果是{}，size={}。", new Object[] {
				this.getClass().getName(), list, list.size() });
		return list;
	}
	...
	public void updateByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的updateByStatementPostfix方法,传递的参数是statementPostfix={},properties={},propertyValues={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
						properties, propertyValues });
		if (StringUtils.isEmpty(statementPostfix))
		...
		try {
			...
			"执行{}的updateByStatementPostfix方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行数据更新时出错！", ex);
		}
		logger.debug("结束执行{}的updateByStatementPostfix方法。", this.getClass()
				.getName());
	}
	...
	public void deleteByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的deleteByStatementPostfix方法,传递的参数是statementPostfix={},properties={},propertyValues={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
						properties, propertyValues });
		if (StringUtils.isEmpty(statementPostfix))
			throw new PersistenceException("自定义SqlMap中的条件语句为空！");
		...
		try {
			...
			"执行{}的deleteByStatementPostfix方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行数据删除时出错！", ex);
		}
		logger.debug("结束执行{}的deleteByStatementPostfix方法。", this.getClass()
				.getName());
	}
	...
	public void insertByStatementPostfix(String statementPostfix,
		...
		logger.debug(
				...
				"开始调用{}的insertByStatementPostfix方法,传递的参数是statementPostfix={},properties={},propertyValues={}。",
				new Object[] { this.getClass().getName(), statementPostfix,
						properties, propertyValues });
		if (StringUtils.isEmpty(statementPostfix))
			throw new PersistenceException("自定义SqlMap中的条件语句为空！");
		...
		try {
			...
			"执行{}的insertByStatementPostfix方法出现异常，具体原因是：{}", new Object[] {
					this.getClass().getName(), ex.getStackTrace() });
			throw new PersistenceException("执行数据插入时出错！", ex);
		}
		logger.debug("结束执行{}的insertByStatementPostfix方法。", this.getClass()
				.getName());
	}
